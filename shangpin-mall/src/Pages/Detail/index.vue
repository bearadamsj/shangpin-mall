        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl
                v-for="(salesAttr, index) in spuSaleAttrList"
                :key="salesAttr.id"
              >
                <dt class="title">{{ salesAttr.saleAttrName }}</dt>
                <dd
                  changepirce="0"
                  :class="{ active: salesValueList.isChecked == 1 }"
                  v-for="(
...
export default {
  ...
  mounted() {
    console.log(this.$route.params.kuid);
