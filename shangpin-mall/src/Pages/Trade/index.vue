  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix" v-for="(address, index) in addresses" :key="address.id">
        ...
        <p @click="changeDefault(address, addresses)">
...
import { mapState } from 'vuex';
  export default {
    ...
    mounted(){
      this.$store.dispatch('getUserAddressAction');
      this.$store.dispatch('getUserOrderAction')
    },
    computed: {
      ...mapState({
      ...
      userDefaultAddress(){
        return this.addresses.find(element => element.isDefault == 1)
      }
    },

    methods: {
      changeDefault(address, addresses){
